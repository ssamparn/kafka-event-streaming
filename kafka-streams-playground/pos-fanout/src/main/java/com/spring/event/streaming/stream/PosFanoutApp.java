...
import com.spring.event.streaming.mapper.RecordMapper;
import com.spring.event.streaming.serdes.AppSerdes;
...
public class PosFanoutApp {
    ...
    private static final String shipmentTopicName = "shipment";
    private static final String notificationTopic = "loyalty";
    private static final String hadoopTopic = "hadoop-sink";
