## Introduction
3. Module used to demo implementations of transactions in kafka producers
...
# delete kafka topics
$ kafka-topics.sh --bootstrap-server localhost:9092 --topic hello-kafka-1 --delete
$ kafka-topics.sh --bootstrap-server localhost:9092 --topic hello-kafka-2 --delete
```
