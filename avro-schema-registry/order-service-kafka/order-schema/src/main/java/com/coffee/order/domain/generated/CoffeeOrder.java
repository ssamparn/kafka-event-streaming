...
public class CoffeeOrder extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -984517142380827299L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CoffeeOrder\",\"namespace\":\"com.coffee.order.domain.generated\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"nickName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"Optional field represents the nick name for the user\",\"default\":\"\"},{\"name\":\"store\",\"type\":{\"type\":\"record\",\"name\":\"Store\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"address\",\"type\":{\"type\":\"record\",\"name\":\"Address\",\"fields\":[{\"name\":\"addressLine1\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"city\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"state_province\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"country\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"zip\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}}]}},{\"name\":\"orderLineItems\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"OrderLineItem\",\"fields\":[{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"size\",\"type\":{\"type\":\"enum\",\"name\":\"Size\",\"symbols\":[\"SMALL\",\"MEDIUM\",\"LARGE\"]}},{\"name\":\"quantity\",\"type\":\"int\"},{\"name\":\"cost\",\"type\":{\"type\":\"bytes\",\"logicalType\":\"decimal\",\"precision\":3,\"scale\":2}}]}}},{\"name\":\"ordered_time\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}},{\"name\":\"pickUp\",\"type\":{\"type\":\"enum\",\"name\":\"PickUp\",\"symbols\":[\"IN_STORE\",\"CURBSIDE\"]}},{\"name\":\"status\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"NEW\"}]}");
  ...
  private com.coffee.order.domain.generated.Store store;
  private java.util.List<com.coffee.order.domain.generated.OrderLineItem> orderLineItems;
  private java.time.Instant ordered_time;
  private com.coffee.order.domain.generated.PickUp pickUp;
   ...
   */
  public CoffeeOrder(java.util.UUID id, java.lang.String name, java.lang.String nickName, com.coffee.order.domain.generated.Store store, java.util.List<com.coffee.order.domain.generated.OrderLineItem> orderLineItems, java.time.Instant ordered_time, com.coffee.order.domain.generated.PickUp pickUp, java.lang.String status) {
    this.id = id;
    this.name = name;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: store = (com.coffee.order.domain.generated.Store)value$; break;
    case 4: orderLineItems = (java.util.List<com.coffee.order.domain.generated.OrderLineItem>)value$; break;
    case 5: ordered_time = (java.time.Instant)value$; break;
    case 6: pickUp = (com.coffee.order.domain.generated.PickUp)value$; break;
   ...
   */
  public com.coffee.order.domain.generated.Store getStore() {
    return store;
  }
   ...
   * @param value the value to set.
   */
  public void setStore(com.coffee.order.domain.generated.Store value) {
    this.store = value;
  }
   ...
   */
  public java.util.List<com.coffee.order.domain.generated.OrderLineItem> getOrderLineItems() {
   ...
   * @param value the value to set.
   */
  public void setOrderLineItems(java.util.List<com.coffee.order.domain.generated.OrderLineItem> value) {
   ...
   */
  public com.coffee.order.domain.generated.PickUp getPickUp() {
    return pickUp;
  }
   ...
   * @param value the value to set.
   */
  public void setPickUp(com.coffee.order.domain.generated.PickUp value) {
    this.pickUp = value;
  }
   ...
   */
  public static com.coffee.order.domain.generated.CoffeeOrder.Builder newBuilder() {
    return new com.coffee.order.domain.generated.CoffeeOrder.Builder();
  }
   ...
   * @return A new CoffeeOrder RecordBuilder
   */
  public static com.coffee.order.domain.generated.CoffeeOrder.Builder newBuilder(com.coffee.order.domain.generated.CoffeeOrder.Builder other) {
    if (other == null) {
      return new com.coffee.order.domain.generated.CoffeeOrder.Builder();
    } else {
      return new com.coffee.order.domain.generated.CoffeeOrder.Builder(other);
    }
  }
   ...
   * @return A new CoffeeOrder RecordBuilder
   */
  public static com.coffee.order.domain.generated.CoffeeOrder.Builder newBuilder(com.coffee.order.domain.generated.CoffeeOrder other) {
    if (other == null) {
      return new com.coffee.order.domain.generated.CoffeeOrder.Builder();
    } else {
      return new com.coffee.order.domain.generated.CoffeeOrder.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CoffeeOrder>
    ...
    private java.lang.String nickName;
    private com.coffee.order.domain.generated.Store store;
    private com.coffee.order.domain.generated.Store.Builder storeBuilder;
    private java.util.List<com.coffee.order.domain.generated.OrderLineItem> orderLineItems;
    private java.time.Instant ordered_time;
    private com.coffee.order.domain.generated.PickUp pickUp;
    private java.lang.String status;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.coffee.order.domain.generated.CoffeeOrder.Builder other) {
      super(other);
      ...
      if (other.hasStoreBuilder()) {
        this.storeBuilder = com.coffee.order.domain.generated.Store.newBuilder(other.getStoreBuilder());
      }
      ...
      if (isValidValue(fields()[6], other.pickUp)) {
        this.pickUp = data().deepCopy(fields()[6].schema(), other.pickUp);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.coffee.order.domain.generated.CoffeeOrder other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coffee.order.domain.generated.CoffeeOrder.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coffee.order.domain.generated.CoffeeOrder.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coffee.order.domain.generated.CoffeeOrder.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coffee.order.domain.generated.CoffeeOrder.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coffee.order.domain.generated.CoffeeOrder.Builder setNickName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coffee.order.domain.generated.CoffeeOrder.Builder clearNickName() {
      nickName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coffee.order.domain.generated.CoffeeOrder.Builder setStore(com.coffee.order.domain.generated.Store value) {
     ...
     * @return This builder.
     */
    public com.coffee.order.domain.generated.Store.Builder getStoreBuilder() {
      if (storeBuilder == null) {
        if (hasStore()) {
          setStoreBuilder(com.coffee.order.domain.generated.Store.newBuilder(store));
        } else {
          setStoreBuilder(com.coffee.order.domain.generated.Store.newBuilder());
        }
      }
      return storeBuilder;
    }
    ...
    public com.coffee.order.domain.generated.CoffeeOrder.Builder setStoreBuilder(com.coffee.order.domain.generated.Store.Builder value) {
      clearStore();
      storeBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coffee.order.domain.generated.CoffeeOrder.Builder clearStore() {
      store = null;
      storeBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coffee.order.domain.generated.CoffeeOrder.Builder setOrderLineItems(java.util.List<com.coffee.order.domain.generated.OrderLineItem> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coffee.order.domain.generated.CoffeeOrder.Builder clearOrderLineItems() {
      orderLineItems = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coffee.order.domain.generated.CoffeeOrder.Builder setOrderedTime(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coffee.order.domain.generated.CoffeeOrder.Builder clearOrderedTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coffee.order.domain.generated.CoffeeOrder.Builder setPickUp(com.coffee.order.domain.generated.PickUp value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coffee.order.domain.generated.CoffeeOrder.Builder clearPickUp() {
      pickUp = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coffee.order.domain.generated.CoffeeOrder.Builder setStatus(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coffee.order.domain.generated.CoffeeOrder.Builder clearStatus() {
      status = null;
    ...
    public CoffeeOrder build() {
      try {
        ...
        if (storeBuilder != null) {
          ...
          record.store = fieldSetFlags()[3] ? this.store : (com.coffee.order.domain.generated.Store) defaultValue(fields()[3]);
        }
        record.orderLineItems = fieldSetFlags()[4] ? this.orderLineItems : (java.util.List<com.coffee.order.domain.generated.OrderLineItem>) defaultValue(fields()[4]);
        record.ordered_time = fieldSetFlags()[5] ? this.ordered_time : (java.time.Instant) defaultValue(fields()[5]);
        record.pickUp = fieldSetFlags()[6] ? this.pickUp : (com.coffee.order.domain.generated.PickUp) defaultValue(fields()[6]);
