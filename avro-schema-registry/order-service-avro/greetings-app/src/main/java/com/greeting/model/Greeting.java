...
public class Greeting extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.greeting.model.Greeting.Builder newBuilder() {
    return new com.greeting.model.Greeting.Builder();
  }
   ...
   * @return A new Greeting RecordBuilder
   */
  public static com.greeting.model.Greeting.Builder newBuilder(com.greeting.model.Greeting.Builder other) {
    if (other == null) {
      return new com.greeting.model.Greeting.Builder();
    } else {
      return new com.greeting.model.Greeting.Builder(other);
    }
  }
   ...
   * @return A new Greeting RecordBuilder
   */
  public static com.greeting.model.Greeting.Builder newBuilder(com.greeting.model.Greeting other) {
    if (other == null) {
      return new com.greeting.model.Greeting.Builder();
    } else {
      return new com.greeting.model.Greeting.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Greeting>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.greeting.model.Greeting.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.greeting.model.Greeting other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.greeting)) {
        this.greeting = data().deepCopy(fields()[0].schema(), other.greeting);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.greeting.model.Greeting.Builder setGreeting(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.greeting.model.Greeting.Builder clearGreeting() {
      greeting = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.greeting.model.Greeting.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.greeting.model.Greeting.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.greeting.model.Greeting.Builder setCreatedDateTime(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.greeting.model.Greeting.Builder clearCreatedDateTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.greeting.model.Greeting.Builder setCreatedDate(java.time.LocalDate value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.greeting.model.Greeting.Builder clearCreatedDate() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.greeting.model.Greeting.Builder setCost(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.greeting.model.Greeting.Builder clearCost() {
      cost = null;
