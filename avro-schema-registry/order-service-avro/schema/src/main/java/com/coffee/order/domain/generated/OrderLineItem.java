...
public class OrderLineItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private com.coffee.order.domain.generated.Size size;
   ...
   */
  public OrderLineItem(java.lang.String name, com.coffee.order.domain.generated.Size size, java.lang.Integer quantity, java.math.BigDecimal cost) {
    this.name = name;
    this.size = size;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: size = (com.coffee.order.domain.generated.Size)value$; break;
   ...
   */
  public com.coffee.order.domain.generated.Size getSize() {
    return size;
  }
   ...
   * @param value the value to set.
   */
  public void setSize(com.coffee.order.domain.generated.Size value) {
    this.size = value;
  }
   ...
   */
  public static com.coffee.order.domain.generated.OrderLineItem.Builder newBuilder() {
    return new com.coffee.order.domain.generated.OrderLineItem.Builder();
  }
   ...
   * @return A new OrderLineItem RecordBuilder
   */
  public static com.coffee.order.domain.generated.OrderLineItem.Builder newBuilder(com.coffee.order.domain.generated.OrderLineItem.Builder other) {
    if (other == null) {
      return new com.coffee.order.domain.generated.OrderLineItem.Builder();
    } else {
      return new com.coffee.order.domain.generated.OrderLineItem.Builder(other);
    }
  }
   ...
   * @return A new OrderLineItem RecordBuilder
   */
  public static com.coffee.order.domain.generated.OrderLineItem.Builder newBuilder(com.coffee.order.domain.generated.OrderLineItem other) {
    if (other == null) {
      return new com.coffee.order.domain.generated.OrderLineItem.Builder();
    } else {
      return new com.coffee.order.domain.generated.OrderLineItem.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderLineItem>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.coffee.order.domain.generated.OrderLineItem.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.coffee.order.domain.generated.OrderLineItem other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coffee.order.domain.generated.OrderLineItem.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coffee.order.domain.generated.OrderLineItem.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coffee.order.domain.generated.OrderLineItem.Builder setSize(com.coffee.order.domain.generated.Size value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coffee.order.domain.generated.OrderLineItem.Builder clearSize() {
      size = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coffee.order.domain.generated.OrderLineItem.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coffee.order.domain.generated.OrderLineItem.Builder clearQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coffee.order.domain.generated.OrderLineItem.Builder setCost(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coffee.order.domain.generated.OrderLineItem.Builder clearCost() {
      cost = null;
    ...
    public OrderLineItem build() {
      try {
        ...
        record.size = fieldSetFlags()[1] ? this.size : (com.coffee.order.domain.generated.Size) defaultValue(fields()[1]);
